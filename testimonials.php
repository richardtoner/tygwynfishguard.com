<?php include("partials/head.php"); ?>
			...
			$testimonials = array(
				...
				array("comments"=>"Had a lovely time, very comfortable and god location for exploring Pembrokeshire","author"=>"The W family, Bradford on Avon, Wilts"),
				array("comments"=>"Lovely cottage, we will be making a return visit","author"=>"M and T, Pemblebury, Trelogan"),
				array("comments"=>"What a find! We have been coming to Pembrokeshire for years but this is the best cottage yet.   Will definitely be returing","author"=>"The Jones family, Port Talbot"),
				...
				array("comments"=>"Gorgeous cottage, very well equipped. Lovely coastal walks and plenty to do in the sea.  We’ve had  fantastic time!","author"=>"V and A, Manchester. J an A, London"),
				...
				array("comments"=>"Out first visit to Pembrokeshire.  From this lovely cottage we did a lot!  Swimming, cycling, walking, coasteering, boat trip, wildlife etc etc.  Every day an outdoor adventure and lovely evenings, with cosy Ty Gwyn to come back to","author"=>"The Jackson and Wheatle families, Kendal, Cumbria"),
			);
